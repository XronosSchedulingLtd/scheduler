...
TABLES = [SchoolBaseTable.new("academicrecord", :all),
          ...
          SchoolBaseTable.new("groups", :all),
          SchoolBaseTable.new("homeworktimetable", :all),
          ...
          SchoolBaseTable.new("pupil",
                              ["PupOrigNum",
                               ...
                               "PupDateofLeaving",
                               "PType"]),
          SchoolBaseTable.new("puptag", :all),
          SchoolBaseTable.new("room",
                              ["RoomIdent",
                               "Room",
                               "RoomName"]),
          SchoolBaseTable.new("rtrotaweek", :all),
          SchoolBaseTable.new("rtrwgroups", :all),
          SchoolBaseTable.new("rtrwpupils", :all),
          SchoolBaseTable.new("sctinfoyears", :all),
          SchoolBaseTable.new("staff",
                              ["UserIdent",
                               ...
                               "UserFullTime",
                               "PType"]),
          SchoolBaseTable.new("staffcategories", :all),
          SchoolBaseTable.new("staffcategorytypes", :all),
          SchoolBaseTable.new("subjects",
                              ["SubCode",
                               "SubName",
                               "SubIdent"]),
          SchoolBaseTable.new("suspendedlessons", :all),
          SchoolBaseTable.new("tags", :all),
          SchoolBaseTable.new("timetable", :all),
