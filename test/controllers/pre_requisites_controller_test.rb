...
class PreRequisitesControllerTest < ActionController::TestCase
  ...
  test "should create pre_requisite" do
    assert_difference('PreRequisite.count') do
      post :create, pre_requisite: { description: @pre_requisite.description, element_id: @pre_requisite.element_id, label: @pre_requisite.label, priority: @pre_requisite.priority }
    end

    assert_redirected_to pre_requisite_path(assigns(:pre_requisite))
  end
  ...
  test "should update pre_requisite" do
    patch :update, id: @pre_requisite, pre_requisite: { description: @pre_requisite.description, element_id: @pre_requisite.element_id, label: @pre_requisite.label, priority: @pre_requisite.priority }
    assert_redirected_to pre_requisite_path(assigns(:pre_requisite))
  end
