...
ActiveRecord::Schema.define(version: 2020_03_12_090509) do
  ...
  create_table "ahoy_messages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.string "user_type"
    t.text "to"
    t.string "mailer"
  ...
  create_table "commitments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "event_id"
  ...
  create_table "concern_sets", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.integer "owner_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "concerns", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.integer "element_id"
  ...
  create_table "datasources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "elements", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.integer "entity_id"
  ...
  create_table "eras", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.date "starts_on"
    t.date "ends_on"
    t.datetime "created_at"
  ...
  create_table "event_collections", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "era_id"
  ...
  create_table "eventcategories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
  ...
  create_table "eventsources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "exam_cycles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
  ...
  create_table "freefinders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "element_id"
    t.string "name"
    t.integer "owner_id"
    t.date "on"
  ...
  create_table "itemreports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "journal_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "locationaliases", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.integer "source_id"
  ...
  create_table "otherhalfgrouppersonae", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "source_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "pre_requisites", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "label"
    t.text "description"
    t.integer "element_id"
    t.integer "priority"
  ...
  create_table "promptnotes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", default: ""
    t.text "prompt"
  ...
  create_table "properties", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean "make_public", default: false
  ...
  create_table "proto_commitments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "proto_event_id"
    t.integer "element_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "proto_events", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.text "body"
    t.date "starts_on"
    t.date "ends_on"
  ...
  create_table "proto_requests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "proto_event_id"
    t.integer "element_id"
    t.integer "quantity"
    t.datetime "created_at"
  ...
  create_table "pupils", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.string "surname"
    t.string "forename"
    t.string "known_as"
  ...
  create_table "requests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "event_id"
    t.integer "element_id"
  ...
  create_table "resourcegrouppersonae", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "rota_slots", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "rota_template_id"
    t.time "starts_at"
    t.time "ends_at"
    t.text "days"
  ...
  create_table "rota_template_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "rota_templates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean "current", default: true
  ...
  create_table "staffs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.string "initials"
    t.string "surname"
    t.string "title"
  ...
  create_table "staffs_subjects", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "staff_id"
  ...
  create_table "staffs_teachinggrouppersonae", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "staff_id"
  ...
  create_table "subjects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.boolean "current", default: true
    t.integer "datasource_id"
    t.integer "source_id"
  ...
  create_table "taggrouppersonae", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "source_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "teachinggrouppersonae", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "source_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "subject_id"
  ...
  create_table "tutorgrouppersonae", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "house"
    t.integer "staff_id"
    t.integer "start_year"
    t.datetime "created_at"
  ...
  create_table "user_files", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "owner_id"
  ...
  create_table "user_form_responses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_form_id"
    t.integer "parent_id"
    t.string "parent_type"
    t.integer "user_id"
  ...
  create_table "user_forms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
  ...
  create_table "user_profiles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.text "permissions"
    t.datetime "created_at"
    t.datetime "updated_at"
